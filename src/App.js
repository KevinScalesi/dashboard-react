...
class App extends Component {
  ...
  componentDidMount(){
    this.apiCall("http://localhost:3001/api/users/total", this.updateState,"totalUsers")
    this.apiCall("http://localhost:3001/api/products/total", this.updateState,"totalProducts")
    this.apiCall("http://localhost:3001/api/products/amount", this.updateState,"amountProducts")
  }
  ...
  render(){
    ...
    let smallBoxes = [
      ...
      },
      {
        ...
        icon: "fa-dollar-sign",
        value: this.state.amountProducts,
